...
<body>
    ...
    <?php
    $v = mysqli_query($link, "SELECT * FROM activo WHERE fecha BETWEEN '$f1' AND '$f2'");
    while ($costos = mysqli_fetch_row($v)) {
    ?>
        <?php echo $costos[0] ?> - <?php echo $costos[1] ?> - <?php echo $costos[2] ?> - <?php echo $costos[3] ?> - <?php echo $costos[4] ?>- <?php echo $costos[5] ?> </br> </br>
    <?php } ?>
</body>
